...
def test_constructor():
    ...
    print('Numpy data shape:', ts_data.data(format='numpy').shape)
    print('Tensor data shape:', ts_data.data(format='tensor').shape)
    print('Numpy targets shape:', ts_data.targets(format='numpy').shape)
    print('Tensor targets shape:', ts_data.targets(format='tensor').shape)
